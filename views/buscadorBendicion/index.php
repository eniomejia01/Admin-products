<div class="navBuscador">
    <h1 class="titleBuscador">Buscar productos Bendición</h1>
</div>
...
<div class="contenedor">
    ...
    <div class="verProductos">
        ...
        <a href="/manager">Ver todos los productos</a>
    </div>
                ...
                <?php if (!empty($resultado)): ?>
                    <?php foreach ($resultado as $propiedad): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/tienda_bendicion/actualizar?id=<?php echo $propiedad->id; ?>&tabla=<?php echo $propiedad->tabla_origen; ?>" class="boton-amarillo-actualizar">Actualizar</a>
                            </td>
